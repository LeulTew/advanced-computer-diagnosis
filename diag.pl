...
main :-
    ...
    write('6. Save knowledge to file'), nl,
    write('7. Load knowledge from file'), nl,
    write('8. Exit'), nl,
    read(Choice),
...
handle_choice(6) :- save_knowledge, !.
handle_choice(7) :- load_knowledge, !.
handle_choice(8) :- write('Goodbye!'), nl, !.
